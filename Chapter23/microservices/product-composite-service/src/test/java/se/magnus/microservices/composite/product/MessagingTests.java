...
import static com.chensoul.ecommerce.composite.product.IsSameEvent.sameEventExceptCreatedAt;
...
class MessagingTests {
    ...
    void createCompositeProduct1() {
        ...
        Event<Integer, Product> expectedEvent =
            new Event(CREATE, composite.getProductId(), new Product(composite.getProductId(), composite.getName(), composite.getWeight()));
    ...
    void createCompositeProduct2() {
        ...
        Event<Integer, Product> expectedRecommendationEvent =
            new Event(CREATE, composite.getProductId(),
                new Recommendation(composite.getProductId(), rec.getRecommendationId(), rec.getAuthor(), rec.getRate(), rec.getContent()));
        ...
        Event<Integer, Product> expectedReviewEvent =
            new Event(CREATE, composite.getProductId(), new Review(composite.getProductId(), rev.getReviewId(), rev.getAuthor(), rev.getSubject(), rev.getContent()));
